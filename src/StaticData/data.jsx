...
export const recommendedforYou = [
  {
    image: generateImgPath("/assets/images/sprain (1).jpg"),
    title: "episode_page.giikre",
    movieTime: "2hr: 30mins",
  },
  {
    image: generateImgPath("/assets/images/dislocation (1).png"),
    title: "episode_page.arrival",
    movieTime: "3hr: 00mins",
  },
  {
    image: generateImgPath("/assets/images/tear-rasions.jpg"),
    title: "episode_page.pricess",
    movieTime: "1hr: 45mins",
  },
  {
    image: generateImgPath("/assets/images/rotator-cuff (1).jpg"),
    title: "episode_page.soull_meate",
    movieTime: "2hr: 30mins",
  },
  {
    image: generateImgPath("/assets/images/arthritis (1).webp"),
...
export const latestMovie = [
  {
    image: "/assets/images/lectures/02.jpg",
    title: "ACL Tear Assessment: A Comprehensive Guide", // More descriptive title
    description:
      "Learn to accurately assess ACL tears using MRI and clinical findings. Covers common pitfalls and advanced diagnostic techniques.", // NEW FIELD
    duration: "45 mins", // Renamed from movieTime
    level: "Beginner",
    cmeCredits: "0.75 AMA PRA Category 1 Credits™", // NEW FIELD
    specialty: "Orthopedic Imaging", // Renamed from category to be more specific
    status: "Free",
    tags: ["ACL", "Knee", "Sports Medicine", "MRI"], // Added MRI to tags
    difficulty: "Easy", // Can keep if you want more granularity than 'level'
    instructor: "Dr. Sarah Johnson",
    detailLink: "/lectures/acl-tear-assessment-guide", // NEW FIELD
    previewVideoUrl: "/assets/videos/acl_tear_preview.mp4", // NEW FIELD (example path)
  },
  {
    image: "/assets/images/lectures/03.jpg",
    title: "Advanced Diagnostics of Shoulder Impingement Syndrome",
    description:
      "Explore the latest imaging modalities and differential diagnoses for shoulder impingement, including dynamic ultrasound and MRI.",
    duration: "38 mins",
    level: "Intermediate",
    cmeCredits: "0.5 AMA PRA Category 1 Credits™",
    specialty: "Musculoskeletal Radiology",
    status: "Premium",
    tags: ["Shoulder", "Impingement", "Ultrasound", "MRI"],
    difficulty: "Medium",
    instructor: "Dr. Michael Chen",
    detailLink: "/lectures/shoulder-impingement-diagnostics",
    previewVideoUrl: "/assets/videos/shoulder_imp_preview.mp4",
  },
  {
    image: "/assets/images/lectures/04.jpg",
    title: "Hip Labral Tear Diagnosis & Management Strategies",
    description:
      "In-depth analysis of hip labral tear presentation, advanced imaging techniques, and surgical vs. non-surgical management options.",
    duration: "52 mins",
    level: "Advanced",
    cmeCredits: "1.0 AMA PRA Category 1 Credits™",
    specialty: "Orthopedic Imaging",
    status: "Free",
    tags: ["Hip", "Labrum", "MRI Arthrogram", "Management"],
    difficulty: "Hard",
    instructor: "Dr. Emily Rodriguez",
    detailLink: "/lectures/hip-labral-tear-diagnosis",
    previewVideoUrl: "/assets/videos/hip_labral_preview.mp4",
  },
  {
    image: "/assets/images/lectures/05.jpg",
    title: "Clinical Cases: Meniscus Injury Interpretation",
    description:
      "Review a series of real-world meniscus injury cases, focusing on MRI interpretation, common tears, and clinical correlation.",
    duration: "41 mins",
    level: "Beginner",
    cmeCredits: "0.75 AMA PRA Category 1 Credits™",
    specialty: "Knee Imaging",
    status: "Free",
    tags: ["Meniscus", "Knee", "MRI", "Case Study"],
    difficulty: "Easy",
    instructor: "Dr. James Wilson",
    detailLink: "/lectures/meniscus-injury-cases",
    previewVideoUrl: "/assets/videos/meniscus_cases_preview.mp4",
  },
  {
    image: "/assets/images/movies/latest/05.webp", // Consider renaming folder/files to be consistent with 'lectures'
    title: "Comprehensive Review of Rotator Cuff Pathology",
    description:
      "Understand the spectrum of rotator cuff injuries, from tendinopathy to full-thickness tears, with imaging examples.",
    duration: "47 mins",
    level: "Intermediate",
    cmeCredits: "0.75 AMA PRA Category 1 Credits™",
    specialty: "Shoulder Imaging",
    status: "Premium",
    tags: ["Rotator Cuff", "Shoulder", "MRI", "Pathology"],
    difficulty: "Medium",
    instructor: "Dr. Lisa Thompson",
    detailLink: "/lectures/rotator-cuff-pathology",
    previewVideoUrl: "/assets/videos/rotator_cuff_preview.mp4",
  },
  {
    image: "/assets/images/movies/latest/06.webp", // Consider renaming folder/files
    title: "Ankle Sprain Assessment: A Radiologist's Approach",
    description:
      "Detailed guidance on assessing ankle sprains, identifying ligamentous injuries, and differentiating grades using various imaging modalities.",
    duration: "33 mins",
    level: "Beginner",
    cmeCredits: "0.5 AMA PRA Category 1 Credits™",
    specialty: "Foot & Ankle Imaging",
    status: "Free",
    tags: ["Ankle", "Sprain", "Ligament", "X-ray", "MRI"],
    difficulty: "Easy",
    instructor: "Dr. Robert Davis",
    detailLink: "/lectures/ankle-sprain-assessment",
    previewVideoUrl: "/assets/videos/ankle_sprain_preview.mp4",
  },
  {
    image: "/assets/images/lectures/06.jpg",
    title: "Advanced Topics in Complex Knee Reconstruction Imaging",
    description:
      "Focuses on post-operative imaging of complex knee reconstructions, including graft assessment and complication detection.",
    duration: "58 mins",
    level: "Advanced",
    cmeCredits: "1.0 AMA PRA Category 1 Credits™",
    specialty: "Knee Post-op Imaging",
    status: "Premium",
    tags: ["Knee", "Reconstruction", "Post-op", "Imaging"],
    difficulty: "Hard",
    instructor: "Dr. Amanda Foster",
    detailLink: "/lectures/complex-knee-reconstruction",
    previewVideoUrl: "/assets/videos/knee_recon_preview.mp4",
  },
  {
    image: "/assets/images/lectures/02.jpg",
    title: "Elbow Tendinopathy: Diagnosis and Treatment Overview",
    description:
      "An overview of common elbow tendinopathies, their diagnostic imaging features, and conservative management principles.",
    duration: "36 mins",
    level: "Intermediate",
    cmeCredits: "0.5 AMA PRA Category 1 Credits™",
    specialty: "Elbow Imaging",
    status: "Free",
    tags: ["Elbow", "Tendon", "Tendinopathy", "Diagnosis"],
    difficulty: "Medium",
    instructor: "Dr. Kevin Martinez",
    detailLink: "/lectures/elbow-tendinopathy",
    previewVideoUrl: "/assets/videos/elbow_tend_preview.mp4",
  },
  {
    image: "/assets/images/lectures/03.jpg",
    title: "Cervical Spine Assessment: Pearls and Pitfalls",
    description:
      "Detailed approach to cervical spine imaging, identifying key anatomical structures and common pathologies.",
    duration: "44 mins",
    level: "Advanced",
    cmeCredits: "0.75 AMA PRA Category 1 Credits™",
    specialty: "Spine Imaging",
    status: "Premium",
    tags: ["Cervical Spine", "Imaging", "Pathology", "MRI"],
    difficulty: "Hard",
    instructor: "Dr. Jennifer Lee",
    detailLink: "/lectures/cervical-spine-assessment",
    previewVideoUrl: "/assets/videos/cervical_spine_preview.mp4",
  },
  {
    image: "/assets/images/lectures/04.jpg",
    title: "Foot and Ankle Biomechanics in Sports Injuries",
    description:
      "Understanding the biomechanics of the foot and ankle, and how they relate to common sports-related injuries and rehabilitation.",
    duration: "49 mins",
    level: "Intermediate",
    cmeCredits: "0.75 AMA PRA Category 1 Credits™",
    specialty: "Biomechanics",
    status: "Free",
    tags: ["Foot", "Ankle", "Biomechanics", "Sports Injuries"],
    difficulty: "Medium",
    instructor: "Dr. Thomas Anderson",
    detailLink: "/lectures/foot-ankle-biomechanics",
    previewVideoUrl: "/assets/videos/foot_ankle_preview.mp4",
  },
];
